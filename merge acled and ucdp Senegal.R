...
gsenegal_exp$date_duration <- gsenegal_exp$date_start + gsenegal_exp$dupnum
gsenegal_exp<- arrange(gsenegal_exp, date_duration)
...
gsenegal_dyad<- gsenegal_exp[,c(20,8,9,12,13,11,17)]
asenegal_dyad<- asenegal_mini[,c(3,6,8,12,13,14,15)]
