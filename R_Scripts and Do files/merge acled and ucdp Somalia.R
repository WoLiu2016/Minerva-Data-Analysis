...
asomalia_mini$DYAD_NAME<- paste(as.character(asomalia_mini$ACTOR1),as.character(asomalia_mini$ACTOR2), sep = "-")
...
asomalia_dyad<- asomalia_mini[,c(3,6,8,12,13,14,15,16)]