...
anigeria_mini$DYAD_NAME<- paste(as.character(anigeria_mini$ACTOR1),as.character(anigeria_mini$ACTOR2), sep = "-")
...
anigeria_dyad<- anigeria_mini[,c(3,6,8,12,13,14,15,16)]
