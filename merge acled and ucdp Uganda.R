...
guganda_exp$date_duration <- guganda_exp$date_start + guganda_exp$dupnum
guganda_exp<- arrange(guganda_exp, date_duration)
...
guganda_dyad<- guganda_exp[,c(20,8,9,12,13,11,17)]
