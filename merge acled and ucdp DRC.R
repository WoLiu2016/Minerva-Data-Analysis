...
gdrcongo_exp$date_duration <- gdrcongo_exp$date_start + gdrcongo_exp$dupnum
gdrcongo_exp<- arrange(gdrcongo_exp, date_duration)
...
gdrcongo_dyad<- gdrcongo_exp[,c(20,8,9,12,13,11,17)]
adrcongo_dyad<- adrcongo_mini[,c(3,6,8,12,13,14,15)]