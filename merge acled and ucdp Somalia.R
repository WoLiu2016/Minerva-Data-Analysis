...
gsomalia_exp$date_duration <- gsomalia_exp$date_start + gsomalia_exp$dupnum
gsomalia_exp<- arrange(gsomalia_exp, date_duration)
...
gsomalia_dyad<- gsomalia_exp[,c(20,8,9,12,13,11,17)]
